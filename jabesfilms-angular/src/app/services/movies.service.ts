...
const STORAGE_KEY = 'jabesFilmsFavorites';
...
const MOVIES: Movie[] = [
  {
    ...
    backdrop: 'https://librisenzagloria.com/wp-content/uploads/2024/02/dune-2-banner-4.png',
  ...
  },
  {
    ...
    trailer: 'https://www.youtube.com/embed/t3yJ-Am4MPw',
  ...
  },
  {
    ...
    backdrop: 'https://image.tmdb.org/t/p/original/xfNHRI2f5kHGvogxLd0C5sB90L7.jpg',
  ...
  },
  {
    ...
    backdrop: 'https://image.tmdb.org/t/p/original/5YbSx0NlHnJNHhEq2NjrFVA0Fa9.jpg',
  ...
  },
  {
    ...
    poster: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRnYTEqiEXFd6LJfXdYJRNzXGY7dAHpFMRMiFgcP8ClEHFHLcOH',
    backdrop: 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRnYTEqiEXFd6LJfXdYJRNzXGY7dAHpFMRMiFgcP8ClEHFHLcOH',
    trailer: 'https://www.youtube.com/embed/HZHkCwsRPOE',
